...
export default function WhyNetguru() {
  return (
    <section 
      className="py-35 text-white relative">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-10 lg:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-stretch">
          ...
          <div className="flex h-full flex-col justify-between">
            ...
            <p className="text-[#ebebeb] text-[18px] font-[600] text-lg">
              With a worldwide footprint, record-high NPS, and end-to-end services,
              we are your one-stop shop for digital product talent.
            </p>
          </div>
          ...
          {numbers.map((item) => (
            ...
            >
              ...
              <p className="text-[14px] font-[600] text-[#ebebeb]">{item.label}</p>
            </div>
          ))}
            </div>
          </div>
