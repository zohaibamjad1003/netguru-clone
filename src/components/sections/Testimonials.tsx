...
const testimonials = [
  ...
  },
  {
    id: 3,
    topImage: '/zabka.svg',
    quote: 'Cooperation with Netguru allowed us to efficiently deliver our vision.',
  ...
  },
  {
    ...
    quote: 'Netguru’s mobile experience produced a robust solution that fully meets our objectives.',
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    {testimonial.id !== 3 ? (
                      <p className="">
                        <span className="text-white font-[700] text-[14px]">{testimonial.name}</span>
                        <span className="mx-2 text-xs text-white/70">/</span>
                        <span className="text-[#ebebeb] font-[400] text-[14px]">{testimonial.role}</span>
                      </p>
                    ) : (
                      <>
