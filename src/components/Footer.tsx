        ...
        <div className="py-22 flex flex-col gap-10">
          <div className="flex flex-col gap-4 text-left">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <img
                ...
                className="w-30 object-contain filter "
              />
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 md:flex md:flex-wrap md:justify-between md:gap-10 mt-0">
            {[
              {
                src: "/olx.svg",
                label: "21% Higher Conversion for a Top RE Marketplace",
              },
              {
                src: "/delivery-hero.svg",
                label:
                  "Scaling Core Apps for Delivery Hero, a Q-Commerce Giant",
              },
              {
                src: "/vinted-go.svg",
                label: "Ecommerce Boost with On-Demand Team Extension",
              },
              {
                src: "/zabka.svg",
                label: "System Architecture for Autonomous Stores by Żabka",
              },
            ].map((item) => (
              <div
                key={item.label}
                className="group w-full md:basis-[18%] md:max-w-[18%] flex flex-col items-start gap-4 text-left"
              >
                <img
                  src={item.src}
                  alt={item.label}
                  className="h-15 w-16 object-contain filter brightness-0 invert"
                />
        ...
        <div className="border-t border-[#505050] py-8">
          <div className="flex flex-col gap-10 md:flex-row md:justify-between">
            <div className="w-full md:basis-[48%] md:min-w-[320px]">
              <h3 className="text-white text-[14px] font-[400] mb-4">
                Partnerships:
              </h3>
              <div className="flex flex-wrap justify-between gap-4">
                {[
                  "/microsoft.svg",
                  "/aws.svg",
                  "/google-cloud-partner.svg",
                  "/webflow-premium-partner.svg",
                ].map((src) => (
                  <img
                    key={src}
                    src={src}
                    alt="Partner logo"
                    className="h-24 w-[100px] object-contain filter brightness-0 invert"
                  />
                ))}
              </div>
            </div>
            ...
            <div className="w-full md:basis-[48%] md:min-w-[320px]">
              ...
              <div className="flex flex-wrap justify-between gap-4">
                {[
                  "/clutch.svg",
                  "/inc-5000.svg",
                  "/ey-entrepreneur-of-the-year.svg",
                  "/forbes.svg",
                ].map((src) => (
                  <img
                    key={src}
          ...
          <div className="grid gap-10 lg:grid-cols-[14%_20%_25%_25%]">
            <div className="grid grid-cols-2 gap-10 lg:contents">
              <div className="lg:w-[100%]">
                <h3 className="text-white text-[18px] font-[700] mb-4">
                  Netguru S.A.
                </h3>
              ...
              <div>
                <p className="text-white text-[12px] font-300 md:pt-10 mb-4">
                  VAT-ID: PL7781454968 <br />
                  REGON: 300826280 <br />
                  KRS: 0000745671
                </p>
                <div className="flex flex-wrap gap-4">
                  {[
                    ...
                    <img
                      key={src}
                      src={src}
                      className="h-10 w-[20px] object-contain filter brightness-0 invert"
                    />
                  ))}
                </div>
              </div>
                ...
                <div className="flex flex-nowrap gap-6 overflow-x-auto md:flex-wrap md:gap-12">
                  {["/b-corp.svg", "/tuv-nord.svg"].map((src) => (
                    <img
                      ...
                      src={src}
                      alt="Client logo"
                      className="h-[60px] md:h-[80px] mt-[20px] object-contain filter brightness-0 invert"
                    />
                  ))}
                </div>
              </div>
